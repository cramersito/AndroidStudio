...
public class Quiz extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pregunta.setText(quizQuestions[indice].getQuesion());
        respuesta1.setText(quizQuestions[indice].getAnswer1());
        respuesta2.setText(quizQuestions[indice].getAnswer2());
        respuesta3.setText(quizQuestions[indice].getAnswer3());
        respuesta4.setText(quizQuestions[indice].getAnswer4());
    ...
    public void finishQuiz(){
        ...
        finalScore.setText("Score: " + puntuacion);
